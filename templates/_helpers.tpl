...
{{- define "harbor.adminSecretName" -}}
  {{- if .Values.harborAdminExistingSecret -}}
    {{- .Values.harborAdminExistingSecret -}}
  {{- end -}}
{{- end -}}

{{- define "harbor.adminSecretKey" -}}
  {{- if .Values.harborAdminExistingSecretKey -}}
    {{- .Values.harborAdminExistingSecretKey -}}
  {{- end -}}
{{- end -}}
